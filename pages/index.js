...
Add any other context about the problem here.`);
    ...
    const githubUrl = `https://github.com/trustlists/TrustLists/issues/new?title=${title}&body=${body}&labels=bug,company-listing`;
    ...
    <>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "sameAs": [
                "https://github.com/trustlists/TrustLists"
              ]
            })
          }}
        />
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-docs-card">
        ...
        <div className="xl:flex xl:h-screen xl:overflow-hidden">
          ...
          <div className="xl:w-96 2xl:w-[28rem] bg-white dark:bg-docs-card shadow-sm xl:flex-shrink-0 xl:border-r xl:border-gray-200 dark:xl:border-gray-700">
            <div className="p-4 sm:p-6 lg:p-8 text-center xl:text-left flex flex-col items-center xl:items-start">
              ...
              <div className="flex flex-col space-y-4 items-center xl:items-start w-full">
                <a 
                  href="https://github.com/trustlists/TrustLists" 
                  target="_blank" 
          ...
          <div className="flex-1 xl:overflow-y-auto xl:h-screen max-w-screen-2xl 2xl:max-w-none mx-auto xl:mx-0">
