    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        <div className="lg:flex lg:h-screen lg:overflow-hidden">
          ...
          <div className="flex-1 lg:overflow-y-auto lg:h-screen max-w-7xl 2xl:max-w-[1600px] mx-auto lg:mx-0">
            <div className="p-4 sm:p-6 lg:p-8">
            {/* Search Bar */}
            <div className="mb-8">
              <div className="mb-4">
            ...
            {/* Company Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-4 gap-4 sm:gap-6">
